...
void drw()
{
 Surf_Printf8X8(0,vid_buf.sheight-9,Vid_FindRGB((int)globaltime%10+30,
 (int)globaltime%10+30,(int)globaltime%10+30),&biosfont,&vid_buf,"%0.3f",globaltime);
}
...
int main()
{
 ...
 InitConsole(&biosfont,Vid_FindRGB(32,32,32),&cf,"conbmp.bmp",0.5,0.1);
 Con_SetnLines (1);
 InitVid();
 Vid_SetMode(2);
 c1=Vid_FindRGB(63,63,63);
 c2=Vid_FindRGB(32,32,32);
 c3=Vid_FindRGB(55,55,55);
 Loop_Entry();
}
